        ...
        <div className="mt-10 flex justify-between">
            <div>
                ...
                <div className="flex gap-5 mt-5">
                    {arr.map((item) => (
                        <div className="py-1 px-3 rounded-full bg-blue-500/30 flex gap-1 items-center md:mt-5">
            ...
            <div className="font-semibold text-3xl md:text-4xl">${car.price.toLocaleString()}</div>
        </div>
    )
}
